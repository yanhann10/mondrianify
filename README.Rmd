...
Want to create abstract artworks in the style of Piet Mondrian instantly? Here we throw in some bright colors and revitalized energy of the grandmaster in two distinct styles based on his time in Paris and New York, all generable with random numbers of your choice on the backend of ggplot2.
